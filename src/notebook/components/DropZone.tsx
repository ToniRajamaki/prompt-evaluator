      ...
      <button
        ...
        className={`group flex w-full items-center justify-center gap-2 rounded-lg border border-dashed px-3 py-2.5 text-center transition disabled:opacity-60 ${
          dragOver
            ...
            : 'border-gray-300 bg-gray-50/50 hover:border-sky-400 hover:bg-sky-50/50'
        }`}
      >
        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-white text-gray-400 shadow-sm ring-1 ring-gray-200 transition group-hover:text-sky-500">
          {busy ? (
