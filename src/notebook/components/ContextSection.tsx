  ...
  return (
    <div className="rounded-lg border border-sky-200 bg-sky-50/50">
      <div className="flex items-center justify-between px-2.5 py-1.5">
        <span className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-sky-600">
      ...
      <ul className="flex flex-col gap-0.5 px-1.5 pb-1.5">
        {folders.map((folder) => (
          <li key={folder.id}>
            <div
              className="group flex h-7 items-center gap-2 rounded-md px-1.5 text-sm text-sky-900/80 transition hover:bg-white/70"
              title={folder.name}
            >
              <svg
              ...
              <button
                ...
                className="flex h-5 w-5 shrink-0 items-center justify-center rounded text-sky-400 transition hover:bg-rose-100 hover:text-rose-600"
              >
            ...
            <li key={source.id}>
              <div
                ...
                className={`group flex h-7 cursor-pointer items-center gap-2 rounded-md px-1.5 text-sm transition ${
                  active
                    ? 'bg-white text-sky-900 ring-1 ring-inset ring-sky-200'
