    ...
    >
      ...
      {source.selected ? (
        <button
          ...
          className="flex h-5 w-5 shrink-0 items-center justify-center rounded text-sky-500 transition hover:bg-sky-100 hover:text-sky-700"
        >
        ...
        <button
          ...
          className="flex h-5 w-5 shrink-0 items-center justify-center rounded text-gray-400 opacity-0 transition hover:bg-sky-100 hover:text-sky-600 group-hover:opacity-100"
        >
          <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
