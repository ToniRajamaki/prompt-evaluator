      ...
      <button
        ...
        className={`flex h-9 w-9 items-center justify-center rounded-lg transition ${
          active
            ...
            : source.selected
              ? 'bg-white ring-1 ring-inset ring-sky-200'
              : 'hover:bg-gray-100'
        }`}
      >
        <svg
...
function RailFolder({
  ...
  return (
    <li className="group relative">
      <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-white ring-1 ring-inset ring-sky-200">
        <svg
  ...
  return (
    <div className="flex flex-1 flex-col overflow-visible">
      ...
      {contextFolders.length + contextSources.length > 0 && (
        <div className="mx-auto mb-2 flex w-9 flex-col items-center gap-1 rounded-xl border border-sky-200 bg-sky-50/60 py-2">
          <span className="flex h-4 min-w-4 items-center justify-center rounded-full bg-sky-600 px-1 text-[10px] font-semibold text-white">
      ...
      <div className="mt-auto flex justify-center border-t border-gray-100 p-2">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-dashed border-gray-300 bg-gray-50/50 text-gray-500 transition hover:border-sky-400 hover:bg-sky-50/50 hover:text-sky-600 disabled:opacity-50"
        >
